...
function createRowACtion(item) {
    ...
    if (!item) {
        ...
        actions = '<button class="button-cancel always-show" onclick="onEditOrCancel(this, \'CANCEL\')">Cancel</button>' +
            '<button class="button-save always-show" onclick="onSaveOrDelete(this, \'SAVE\')">Save</button>';
